...
class LanguageInfoRequestV1(Model):
    """Language Info API request definition.
    ...
    def __init__(self, app_id, descriptors=None, language_id=None, language_ux_id=None, run_on_profile_id=None):
        super(LanguageInfoRequestV1, self).__init__()
        self.app_id = app_id
